...
PV['static-factory'].number = {
    ...
    steps: function() {
        return [
            ...
            { elementId: 'cls-sf-cache', label: 'Cache lookup', description: 'Cache miss for key 42', descriptionKey: 'static-factory.step.number.2', logType: 'CACHE', arrowFromOffset: { x: 0, y: 0.3 }, arrowToOffset: { x: 0, y: 0.3 } },
            ...
            { elementId: 'cls-sf-cache', label: 'Cache store', description: 'Cached: 42 -> Integer(42)', descriptionKey: 'static-factory.step.number.4', logType: 'CACHE', arrowFromId: 'cls-sf-integer' },
            { elementId: 'cls-sf-factory', label: 'Return', description: 'Return Integer(42) as Number to client', descriptionKey: 'static-factory.step.number.5', logType: 'RESPONSE', arrowFromId: 'cls-sf-cache', arrowFromOffset: { x: 0, y: 0.3 }, arrowToOffset: { x: 0, y: 0.3 } },
            ...
            { elementId: 'cls-sf-cache', label: 'Cache lookup', description: 'Cache HIT for key 42', descriptionKey: 'static-factory.step.number.7', logType: 'CACHE', arrowFromOffset: { x: 0, y: -0.3 }, arrowToOffset: { x: 0, y: -0.3 } },
            { elementId: 'cls-sf-factory', label: 'Return cached', description: 'Return cached Integer(42) — same instance, no allocation', descriptionKey: 'static-factory.step.number.8', logType: 'RESPONSE', spawnId: 'obj-sf-int2', spawnLabel: 'Integer(42) [cached]', arrowFromId: 'cls-sf-cache', arrowFromOffset: { x: 0, y: -0.3 }, arrowToOffset: { x: 0, y: -0.3 } },
            ...
            { elementId: 'cls-sf-factory', label: 'Return', description: 'Return Float(3.14) as Number to client', descriptionKey: 'static-factory.step.number.12', logType: 'RESPONSE', arrowFromId: 'cls-sf-float' }
        ];
    },
