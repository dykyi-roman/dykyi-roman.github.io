...
PV['static-factory'].number = {
    ...
    steps: function() {
        return [
            ...
            { elementId: 'obj-sf-int1', label: 'Create Integer', description: 'new Integer(42) — instantiate concrete product', descriptionKey: 'static-factory.step.number.3', logType: 'CREATE', spawnId: 'obj-sf-int1', spawnLabel: 'Integer(42)', arrowFromId: 'cls-sf-integer' },
            ...
            { elementId: 'obj-sf-float1', label: 'Create Float', description: 'new Float(3.14) — instantiate concrete product', descriptionKey: 'static-factory.step.number.11', logType: 'CREATE', spawnId: 'obj-sf-float1', spawnLabel: 'Float(3.14)', arrowFromId: 'cls-sf-float' },
