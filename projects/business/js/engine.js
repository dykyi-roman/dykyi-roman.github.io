...
/* Набор просчитан и сходится (см. verify.js): выручка 33 465 € нетто, food
   ...
   prime cost 56,7 %, чистая прибыль 5 068 € (15,1 %), окупаемость 24,8 мес,
   денежная точка безубыточности 57 гостей в день (19,6 % загрузки).
   Пессимистичный сценарий остаётся в плюсе — 102 € против 5 068 € базовых, и
