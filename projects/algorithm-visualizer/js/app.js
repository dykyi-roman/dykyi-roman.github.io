...
(function() {
    ...
    var implementedAlgorithms = ['bubble-sort', 'selection-sort', 'insertion-sort', 'merge-sort', 'quick-sort', 'linear-search', 'binary-search', 'jump-search', 'bfs', 'dfs', 'dijkstra', 'bst-operations', 'fibonacci', 'kmp', 'hash-table'];
